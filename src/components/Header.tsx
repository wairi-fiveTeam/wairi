...
export default function Header (){
  ...
  return (
    <>
      <header className={`${mobileHeader === true ? `h-[270px]`:`h-[57px]`} w-full shadow-md`}>
        <div className='w-full flex items-center justify-between px-[40px] py-[10px] min-[320px]:max-lg:px-[10px]'>
          ...
          <div className='shrink-0 w-[30px] hidden min-[320px]:max-lg:flex'>
            <Image className='shrink-0' src={mobileLogo} width={30} height={30} alt='logo'/>
          </div>
           ...
           <ul className='min-[320px]:max-lg:hidden flex items-center gap-2 mr-2 font-normal text-[13px] text-[#616161]'>
            ...
            <div className='shrink-0 flex gap-1'>
              <button className='min-[320px]:max-lg:w-[45px] min-[320px]:max-lg:h-[28px] items-center justify-center text-[13px] flex gap-[4px] rounded-full text-[#FFFFFF] px-[14px] py-[8px] bg-[#2EC8C8] hover:shadow-3xl hover:transition ease-in-out delay-150'>
                <Image className="w-[20px] h-[20px] shrink-0" src={headerOs} width={20} height={20} alt='애플아이콘' />
              <span className='min-[320px]:max-lg:hidden'>App Store</span></button>
            ...
            <div className='flex gap-2'>
              {pathName === '/' ?
                <>
                  ...
                  {
                    mobileHeader === false ? <button onClick={()=>{setMobileHeader((prev)=>!prev)}} className='w-[30px] hidden min-[320px]:max-lg:block'><Image src={hamburgerBar} width={24} height={24} alt='모바일삼단바'/></button>
                ...
                <div className='flex gap-1'>
                  <Link href={'/'}><button className='w-[100px] min-[320px]:max-md:text-[10px] min-[320px]:max-md:w-[70px] min-[320px]:max-lg:p-[1px] min-[320px]:max-lg:w-[90px] min-[320px]:max-lg:h-[30px] flex items-center justify-center min-[320px]:max-lg:text-[12px] text-[13px] rounded-full px-[15px] py-[8px] text-[#2EC8C8] bg-[#E0F5F6] hover:shadow-3xl hover:transition ease-in-out delay-150'>광고주라면?</button></Link>
