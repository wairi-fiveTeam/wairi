      ...
      <div className='bg-[#424242]'>
        <div className='w-[746px] m-auto pt-10 min-[320px]:max-md:w-full pb-10'>
          <div className='min-[320px]:max-sm:hidden w-full flex flex-col items-center'>
            <p className='text-center text-[#FFFFFF] text-[20px] font-bold'>
              투자 가능한 시간에 따라 가격 플랜을 선택하고
              <br />
              마케팅 결과만 받아보세요
            </p>
            <p className='text-center text-[#BDBDBD] text-[18px] mt-6'>
          ...
          <div className='min-[320px]:max-sm:gap-2 min-[320px]:max-sm:ml-[24px] min-[320px]:max-sm:justify-center flex gap-20 w-full justify-end pr-10 mt-10'>
            ...
            <div className='flex flex-col items-center gap-3'>
              ...
              {/* mobile */}
              <div
                onClick={() => planHandler("free")}
                className={`hidden cursor-pointer min-[320px]:max-sm:flex ${planCheck === "free" ? `w-[105px] border border-[#B1E7E8] p-[8px] rounded-[14px] flex flex-col items-center gap-[1px]` : `w-[105px] bg-[#B1E7E8] p-[8px] rounded-[14px] flex flex-col items-center gap-[1px]`}`}
              >
                <span
                  className={
                    planCheck === "free"
                      ? `text-[#FFFFFF] font-bold`
                      : `text-[#616161] font-bold`
                  }
                >
                  무료
                </span>
                <span
                  className={
                    planCheck === "free"
                      ? `text-[#B1E7E8] text-[14px]`
                      : `text-[#616161] text-[14px]`
                  }
                >
                  직접진행
                </span>
              </div>
              <button className='min-[320px]:max-sm:hidden rounded-[56px] px-[16px] py-[6px] bg-[#222222] text-[#FFFFFF] text-[14px] font-bold'>
                이용하기
              </button>
            </div>
            {/* 기본멤버쉽 */}
            <div className='flex flex-col items-center gap-3'>
              ...
              {/* mobile */}
              <div
                onClick={() => planHandler("basic")}
                className={`hidden cursor-pointer min-[320px]:max-sm:flex ${planCheck === "basic" ? `w-[105px] border border-[#B1E7E8] p-[8px] rounded-[14px] flex flex-col items-center gap-[1px]` : `w-[105px] bg-[#B1E7E8] p-[8px] rounded-[14px] flex flex-col items-center gap-[1px]`}`}
              >
                <span
                  className={
                    planCheck === "basic"
            ...
            <div className='flex flex-col items-center gap-3'>
              ...
              {/* mobile */}
              <div
                onClick={() => planHandler("premium")}
                className={`hidden cursor-pointer min-[320px]:max-sm:flex ${planCheck === "premium" ? `w-[105px] border border-[#B1E7E8] p-[8px] rounded-[14px] flex flex-col items-center gap-[1px]` : `w-[105px] bg-[#B1E7E8] p-[8px] rounded-[14px] flex flex-col items-center gap-[1px]`}`}
              >
                <span
                  className={
                    planCheck === "premium"
          ...
          <div className='min-[320px]:max-sm:hidden w-full grid grid-cols-4 border-b border-[#9E9E9E] pb-[12px] mt-9'>
            <span className='text-[#FFFFFF] pl-3 text-[14px]'>
              신규 캠페인 생성
            </span>
          ...
          <div className='mt-2'>
            <p className='text-[#9E9E9E] text-[12px] sm:text-[10px]'>
              * 포스팅 원본 전달의 경우, 캠페인 신청 전 동의하지 않은
              인플루언서의 파일은 전달이 불가할 수 있음을 사전에 알려드립니다.
            </p>
          </div>
