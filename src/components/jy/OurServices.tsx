    ...
    <>
      <div className='w-[746px] m-auto flex flex-col min-[320px]:max-md:w-full mt-10 pb-8'>
        <div className='flex flex-col items-start min-[320px]:max-sm:pl-6'>
          <span
            className={`${montserrat.className} text-[#2EC8C8] text-[16px]`}
          >
            OUR SERVICES
          </span>
        ...
        <div className='flex flex-col justify-center items-center mt-8 min-[320px]:max-sm:hidden'>
          ...
          <ul className='flex w-full h-[150px] items-end justify-center'>
            ...
            <div>
              <Image src={ellipse} width={400} height={400} alt='ellipseIcon' />
            </div>
        ...
        <div className='mt-[40px] flex flex-col items-center gap-4'>
          <div className='hidden max-sm:block'>
            <Image src={ellipse} width={300} height={300} alt='ellipseIcon' />
          </div>
          ...
          <button
            onClick={() => setServiceOn((prev) => !prev)}
            className='flex items-center text-[#616161] text-[14px] gap-1 hover:bg-slate-100'
          >
            대행서비스보기
            <div>
              <Image src={downArrow} width={16} height={16} alt='아래화살표' />
            </div>
          </button>
        </div>
      </div>
