    ...
    <footer className='bg-[#424242] w-full py-14 max-md:py-8'>
      <div className='max-w-[1440px] mx-auto px-[100px] max-md:px-5'>
        ...
        <div className='flex gap-[133px] max-md:flex-col max-md:gap-[29px]'>
          ...
          {/* 고객센터 정보 */}
          <div className='max-md:hidden text-white leading-[42px]'>
            <div className='text-[28px]'>와이리 고객센터</div>
            <div className='text-[35px] font-bold'>070-8098-7127</div>
            <div className='text-[28px]'>운영시간 평일 10:00~18:00</div>
          </div>
